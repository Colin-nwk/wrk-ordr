import { ContractModalContent, ContractTable, CustomButton, FilterControl, Heading, SearchInput, Wrapper, HideColumns, SimpleTable, FilterSelect } from "../components"
...
const initialData = [
    { id: '1', status: 'Active', provider: 'Provider A' },
    { id: '2', status: 'Inactive', provider: 'Provider B' },
    { id: '3', status: 'Pending', provider: 'Provider C' },
]
const Projects = () => {
    ...
    return (
        <div className="w-full h-full">
            <div className="flex items-center justify-between space-y-4">
                ...
                <Heading size="lg">
                    List of Projects <span className="text-sm text-primary">(10)</span>
                </Heading>
                <CustomButton label=" Add Project" onClick={() => showModal(ModalType.JOB, {
